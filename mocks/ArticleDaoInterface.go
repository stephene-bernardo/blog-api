...
func (_m *ArticleDaoInterface) FindAll() ([]dao.ArticleObject, error) {
	ret := _m.Called()

	var r0 []dao.ArticleObject
	if rf, ok := ret.Get(0).(func() []dao.ArticleObject); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]dao.ArticleObject)
		}
	}
...
func (_m *ArticleDaoInterface) FindById(id int) (dao.ArticleObject, error) {
	ret := _m.Called(id)

	var r0 dao.ArticleObject
	if rf, ok := ret.Get(0).(func(int) dao.ArticleObject); ok {
		r0 = rf(id)
	} else {
		r0 = ret.Get(0).(dao.ArticleObject)
	}
